...
TARGET_INCREMENT = 600 #this is in miliseconds
...
def main():
    ...
    while run:
        clock.tick(120) #60 means running this while loop in 60 fps, regulates the speed at which this while loop runs
        click = False
